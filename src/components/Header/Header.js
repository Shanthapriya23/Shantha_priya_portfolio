    ...
    return (React.createElement(Container, { className: "header-fixed" },
        React.createElement(Router, null,
            ...
            React.createElement("nav", { className: isActive ? 'active' : '' },
                ...
                React.createElement(NavHashLink, { smooth: true, to: "#experience", onClick: closeMenu }, "Experience"),
                React.createElement(NavHashLink, { smooth: true, to: "#education", onClick: closeMenu }, "Education"),
                React.createElement(NavHashLink, { smooth: true, to: "#certifications", onClick: closeMenu }, "Certifications"),
