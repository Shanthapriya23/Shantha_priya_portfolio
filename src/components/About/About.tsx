...
import Sp_photo from "../../assets/Shantha_priya.jpg";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
          Hi there! I'm J B Shantha priya, a highly motivated Information Technology Undergraduate with a passion for Full Stack Web Development, Machine Learning and Problem-solving.  
          </p>
        </ScrollAnimation>
